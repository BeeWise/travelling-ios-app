//
//  GetUserLocalOperationTests.swift
//  TravellingTests
//
...
class GetUserLocalOperationTests: XCTestCase {
    var sut: GetUserLocalOperation!
    var value: User!
    ...
    func setupSubjectUnderTest() {
        self.sut = GetUserLocalOperation(model: GetUserOperationModels.Request(userId: "userId"), completionHandler: { result in
            switch result {
