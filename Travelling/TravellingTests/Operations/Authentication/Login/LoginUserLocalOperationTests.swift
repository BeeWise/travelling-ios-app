//
//  LoginUserLocalOperationTests.swift
//  TravellingTests
//
...
class LoginUserLocalOperationTests: XCTestCase {
    var sut: LoginUserLocalOperation!
    var value: User!
    ...
    func setupSubjectUnderTest() {
        self.sut = LoginUserLocalOperation(model: LoginUserOperationModels.Request(account: "account", password: "password"), completionHandler: { result in
            switch result {
