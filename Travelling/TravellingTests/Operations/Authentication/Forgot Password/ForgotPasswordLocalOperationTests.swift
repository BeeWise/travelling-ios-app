//
//  ForgotPasswordLocalOperationTests.swift
//  TravellingTests
//
...
class ForgotPasswordLocalOperationTests: XCTestCase {
    var sut: ForgotPasswordLocalOperation!
    var value: String!
    ...
    func setupSubjectUnderTest() {
        self.sut = ForgotPasswordLocalOperation(model: ForgotPasswordOperationModels.Request(email: "email"), completionHandler: { result in
            switch result {
                case .success(let value): self.value = value.message; break
